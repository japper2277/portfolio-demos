...
import {
  ...
  visitDiff,
  white
} from "./chunk-MVCZLDEG.js";
import {
  require_jsx_runtime
} from "./chunk-KF7MZOZ4.js";
import {
  require_react
} from "./chunk-L4KNVKDZ.js";
import {
  __commonJS,
  __toESM
...
// node_modules/sanity/lib/_chunks/StructureToolProvider-bB9pgLAp.js
...
var commentsUsEnglishLocaleBundle = defineLocaleResourceBundle({ locale: "en-US", namespace: commentsLocaleNamespace, resources: () => import("./resources-3ZYxVDQU-X3Q4EIXO.js") });
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({ locale: "en-US", namespace: structureLocaleNamespace, resources: () => import("./resources-7hAPJyyn-3G7AUHXF.js") });
...
async function createOperation(props) {
  const { activeTool, client, comment, currentUser, dataset, documentId, documentType, getIntent: getIntent2, getNotificationValue, getThreadLength, onCreate, onCreateError, projectId, runSetup, workspace } = props;
...
function useCommentOperations(opts) {
  ...
  const handleCreate = (0, import_react3.useCallback)(async (comment) => {
    if (!(currentUser == null ? void 0 : currentUser.id))
      return;
    await createOperation({ activeTool, client, comment, currentUser, dataset, documentId, documentType, getIntent: getIntent2, getNotificationValue, getThreadLength, onCreate, onCreateError, projectId, runSetup, workspace });
  }, [activeTool, client, currentUser, dataset, documentId, documentType, getIntent2, getNotificationValue, getThreadLength, onCreate, onCreateError, projectId, runSetup, workspace]);
...
var structureTool = definePlugin((options) => {
  ...
  return { name: "sanity/structure", document: { actions: (prevActions) => {
    ...
    icon,
    component: (0, import_react3.lazy)(() => import("./index-7N04noJ_-7A7TJJCA.js")),
...
//# sourceMappingURL=chunk-DB3MXZ3B.js.map
