...
const SubtitleText = styled__default.default(ui.Text)(_a || (_a = __template(["\n  margin-top: 2px;\n"])));
const PreviewWrapper = styled__default.default(ui.Box)(_b || (_b = __template(["\n  height: 25px;\n  width: 25px;\n  overflow: hidden;\n"])));
const MenuItem = React.forwardRef(function MenuItem2(_ref4, ref) {
  ...
  const menuItemContent = React.useMemo(() => {
    return /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
      ...
      children: [preview && /* @__PURE__ */jsxRuntime.jsx(PreviewWrapper, {
      ...
      }), text && /* @__PURE__ */jsxRuntime.jsxs(ui.Stack, {
        flex: 1,
        ...
        children: [/* @__PURE__ */jsxRuntime.jsx(ui.Text, {
          ...
          weight: "medium",
          children: text
        }), __unstable_subtitle && /* @__PURE__ */jsxRuntime.jsx(SubtitleText, {
...
//# sourceMappingURL=TooltipDelayGroupProvider-yrTMBNIl.js.map
