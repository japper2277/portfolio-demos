...
import { usePaneLayout, ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, useStructureTool, LOADING_PANE, structureLocaleNamespace, SerializeError, Pane, PaneHeader, PaneContent, LoadingPane, PaneLayout, setActivePanes, StructureToolProvider } from './StructureToolProvider-bB9pgLAp.js';
...
import { Button } from './TooltipDelayGroupProvider-MYd0Yb1I.js';
...
const paneMap = {
  component: lazy(() => import('./index-qO0SW7D8.js')),
  document: lazy(() => import('./pane-zkH8ol1W.js')),
  documentList: lazy(() => import('./pane-Z1d7aPhA.js')),
  list: lazy(() => import('./index-eU-tJGyL.js'))
};
