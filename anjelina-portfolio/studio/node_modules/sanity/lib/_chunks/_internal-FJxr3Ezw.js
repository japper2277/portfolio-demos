...
async function getBuildAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./buildAction-kOG30XDy.js');
  });
  return mod.default;
}
const checkCommand = {
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployAction-ZDJRduq9.js');
    });
...
async function getDevAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./devAction-DaVg9emW.js');
  });
  return mod.default;
}
...
const validateDocumentsCommand$1 = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./validateAction-VlUMMu-b.js');
    });
    return mod.default(args, context);
  }
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployApiAction-DttZxcb0.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$9
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./listApisAction-atBm2hy1.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$8
...
//# sourceMappingURL=_internal-FJxr3Ezw.js.map
