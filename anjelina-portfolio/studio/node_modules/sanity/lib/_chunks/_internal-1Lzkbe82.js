...
async function getBuildAction() {
  const mod = await import('./buildAction-qRR92nWf.js');
  return mod.default;
}
const checkCommand = {
  name: "check",
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployAction-zGslDQuq.js');
...
async function getDevAction() {
  const mod = await import('./devAction-w4FZe4Gl.js');
  return mod.default;
}
...
const validateDocumentsCommand$1 = {
  ...
  helpText: helpText$c,
  action: async (args, context) => {
    const mod = await import('./validateAction-wwnglRWY.js');
    return mod.default(args, context);
  }
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-DfKc1wJ7.js');
    return mod.default(args, context);
  },
  helpText: helpText$9
};
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./listApisAction-vgxK1v5O.js');
    return mod.default(args, context);
  },
  helpText: helpText$8
};
...
//# sourceMappingURL=_internal-1Lzkbe82.js.map
